            ...
            <div className="container-menu-header">
                ...
                <div className="wrap_header">
                    ...
                    <a href="index.html" className="logo">
                        <img src="https://colorlib.com/etc/fashe/images/icons/logo.png" alt="IMG-LOGO" />
                    </a>
                    {/* Menu */}
                    ...
                    <div className="header-icons">
                        <a href="#" className="header-wrapicon1 dis-block">
                            <img src="https://colorlib.com/etc/fashe/images/icons/icon-header-01.png" className="header-icon1" alt="ICON" />
                        </a>
                        <span className="linedivide1" />
                        <div className="header-wrapicon2">
                            <img src="https://colorlib.com/etc/fashe/images/icons/icon-header-02.png" className="header-icon1 js-show-header-dropdown" alt="ICON" />
                                ...
                                <ul className="header-cart-wrapitem">
                                    <li className="header-cart-item">
                                        <div className="header-cart-item-img">
                                            <img src="https://colorlib.com/etc/fashe/images/item-cart-01.jpg" alt="IMG" />
                                        </div>
                                    ...
                                    <li className="header-cart-item">
                                        <div className="header-cart-item-img">
                                            <img src="https://colorlib.com/etc/fashe/images/item-cart-02.jpg" alt="IMG" />
                                        </div>
                                        <div className="header-cart-item-txt">
                                            <a href="#" className="header-cart-item-name">
                                    ...
                                    <li className="header-cart-item">
                                        <div className="header-cart-item-img">
                                            <img src="https://colorlib.com/etc/fashe/images/item-cart-03.jpg" alt="IMG" />
                                        </div>
                                        <div className="header-cart-item-txt">
                                            <a href="#" className="header-cart-item-name">
